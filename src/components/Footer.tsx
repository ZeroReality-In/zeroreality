...
const Footer = () => {
  ...
  return <footer className="bg-background px-6 py-16 md:py-24">
          ...
          <div className="md:col-span-6">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="rounded-3xl overflow-hidden w-full max-w-[240px] md:w-[180px] aspect-square bg-gray-800">
                <img src="/lovable-uploads/c331f054-e65a-4f8d-9e2f-67a5fa523590.png" alt="Contact" className="w-full h-full object-cover" />
              </div>
              <div>
                <h3 className="text-foreground/60 text-lg">General Inquiries</h3>
                <a href="mailto:contact@zeroreality.com" className="text-3xl md:text-4xl font-bold text-foreground hover:text-neon-green transition-colors">
            ...
            <div className="mt-16 relative">
              <motion.div className="border border-foreground/20 rounded-full py-4 px-8 w-fit transform -rotate-12" whileHover={{
              scale: 1.05,
              rotate: -8
            }} transition={{
              type: "spring",
