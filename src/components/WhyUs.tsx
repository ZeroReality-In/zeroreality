...
const ReasonCard = ({
  ...
  return <motion.div className="relative w-full rounded-[2rem] border border-foreground/20 bg-background p-6 md:p-8 overflow-hidden" initial={{
    opacity: 0,
    y: 30
  }} whileInView={{
    opacity: 1,
    ...
    borderColor: "#9b87f5"
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
        <motion.div className="text-5xl font-bold text-muted-foreground/40" initial={{
        opacity: 0,
        x: -20
      }} whileInView={{
        opacity: 1,
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <motion.div className="text-[#9b87f5]" initial={{
            rotate: -10,
            scale: 0.8
          }} whileInView={{
            rotate: 0,
            ...
            <motion.h3 className="text-3xl md:text-4xl xl:text-5xl font-display font-bold text-[#9b87f5]" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} transition={{
          ...
          <motion.p className="text-foreground/80 mt-2" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
        ...
        <motion.div className="absolute -right-4 -top-4 opacity-5 text-7xl" initial={{
        scale: 0.5,
        rotate: -10
      }} whileInView={{
        scale: 1,
...
const WhyUs = () => {
  ...
  return <div id="why-us" ref={containerRef} className="relative pt-32 pb-72 my-16 overflow-hidden md:my-0">
      ...
      <motion.div className="absolute -left-32 bottom-20 w-80 h-80 rounded-full bg-neon-green/5 blur-3xl" style={{
      y: useTransform(scrollYProgress, [0, 1], [-50, 100]),
      scale: useTransform(scrollYProgress, [0, 0.5, 1], [0.9, 1.3, 1])
    }} />

      <motion.div className="mb-20 text-center" style={{
      y: titleY,
      opacity,
      scale,
      rotate: containerRotate
    }}>
        <motion.div className="inline-block bg-black dark:bg-black px-10 py-5 rounded-full border-2 border-[#9b87f5] mb-6" initial={{
        y: -20,
        opacity: 0
      }} whileInView={{
        y: 0,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col gap-4 md:gap-6">
          {reasons.map((reason, index) => <ReasonCard key={index} number={reason.number} title={reason.title} description={reason.description} icon={reason.icon} delay={index + 1} />)}
        </div>
      </div>
    </div>;
};
